<?php include '../connectSQL.php'; session_start();
$officerID = $_SESSION['officerID'];
$officerusername = $_SESSION['username'];
$SQLdata = mysqli_query($connectSQL, "SELECT * FROM user_officer
	WHERE username ='$officerusername' AND officerID = '$officerID'");
...
<div class="container-fluid">
			...
			<ul class="nav navbar-nav">
				...
				<li><a class="dropdown-toggle" data-toggle="dropdown" href="#">Welcome,
